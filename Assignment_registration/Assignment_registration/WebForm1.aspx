<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Assignment_registration.WebForm1" %>
        ...
        <div>
            <table class="auto-style1" style="background-color:darkgray">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" Width="193px" CssClass="txtbox"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="TextBox4" runat="server" TextMode="Date" Width="193px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;
                        Age in Number&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="TextBox6" runat="server" Width="193px" TextMode="MultiLine" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox7" runat="server"  Width="193px" TextMode="MultiLine"></asp:TextBox>
                    &nbsp;
...
&nbsp;<asp:TextBox ID="TextBox11" runat="server" Width="193px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox12" runat="server" Width="193px" ></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox13" runat="server" Width="193px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RadioButton ID="RadioButton10" runat="server" GroupName="r3" Text="Other" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
                    ...
                    <td>
                        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="r2" Text="Computer/IT" />
                        <asp:RadioButton ID="RadioButton4" runat="server" GroupName="r2" Text="Electronics" />
                        <asp:RadioButton ID="RadioButton5" runat="server" GroupName="r2"  Text="Civil" />
                        <asp:RadioButton ID="RadioButton6" runat="server" GroupName="r2" Text="Mechanical" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox9" runat="server" TextMode="Password" Width="193px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox10" runat="server" Width="193px" ></asp:TextBox>
